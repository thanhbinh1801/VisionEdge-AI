...
- Các module nạp luồng video camera (`video-stream-service`) và cơ chế phát âm thành cảnh báo còi bíp không bị ảnh hưởng trực tiếp bởi thay đổi cấu trúc dữ liệu zone và nhãn đối tượng.
...
4. Phát hành và thực thi các gói Gói Tasks mới.
